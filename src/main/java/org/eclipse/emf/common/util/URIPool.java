...
/**
     ...
     */
    final class URIPool extends Pool<URI>
    {
        ...
        protected static class StringAccessUnit extends URIPoolAccessUnitBase
        {
            protected static class Queue extends AccessUnit.Queue<URI>
            {
                ...
                final protected org.eclipse.emf.common.util.URIPool pool;

                public Queue(org.eclipse.emf.common.util.URIPool pool)
                {
                    this.pool = pool;
                }
             ...
             * This unit's pool.
             */
            protected final org.eclipse.emf.common.util.URIPool pool;
            ...
            protected URI parseIntoURI(String uri)
            {
                        ...
                        == DEVICE_IDENTIFIER)
                {
                    ...
                    // If the device is at the end of the ..
                    //
                    if (findTerminatingCharacter == QUERY_SEPARATOR)
                    {
