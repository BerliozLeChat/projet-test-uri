...
final class Hierarchical extends URI {
    ...
    public URI resolve(URI base, boolean preserveRootParents) {
        ...
        return POOL.intern(false, org.eclipse.emf.common.util.URIPool.URIComponentsAccessUnit.VALIDATE_NONE, true, base.scheme(), newAuthority, newDevice, newAbsolutePath, newSegments, newQuery);
    }
    ...
    public URI deresolve(URI base, boolean preserveRootParents, boolean anyRelPath, boolean shorterRelPath) {
        ...
        return POOL.intern(false, org.eclipse.emf.common.util.URIPool.URIComponentsAccessUnit.VALIDATE_NONE, true, null, newAuthority, newDevice, newAbsolutePath, newSegments, newQuery);
    }
    ...
    public URI trimSegments(int i) {
        ...
        return POOL.intern(false, org.eclipse.emf.common.util.URIPool.URIComponentsAccessUnit.VALIDATE_NONE, true, scheme, authority, device, hasAbsolutePath(), newSegments, query);
    }
    ...
    public URI replacePrefix(URI oldPrefix, URI newPrefix) {
        ...
        // no validation needed since all components are from existing URIs
        return POOL.intern(false, org.eclipse.emf.common.util.URIPool.URIComponentsAccessUnit.VALIDATE_NONE, true, newPrefix.scheme(), newPrefix.authority(), newPrefix.device(), newPrefix.hasAbsolutePath(), mergedSegments, query);
    }
}
